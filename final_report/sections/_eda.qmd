...
# Generate individual plots for each numerical variable
...
- `ever_married`: Surprisingly, we notice that unlike for the group of individuals below 60 years old, the proportion of people that had a stroke that have never been married (19.63%) is higher than those who have (12.61%). 
