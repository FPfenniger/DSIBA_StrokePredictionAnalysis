...
BMI is a measure of body fat based on weight in relation to height. The WHO defines the following BMI categories:
...
combined_plot <- subplot(
  ...
  layout(title = "Distribution and Proportions of Key Variables II")
...
suppressWarnings({
  ...
  combined_subplots <- subplot(
    ...
    layout(title = "Distribution and Proportions of Numerical Variables I")
