...
write.csv(train_balanced, "../../data/datasets/training_sets/test_unbalanced.csv", row.names = FALSE)
write.csv(test_balanced, "../../data/datasets/test_sets/test_unbalanced.csv", row.names = FALSE)
