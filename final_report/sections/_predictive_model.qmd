...
# 'continuous_vars' and 'train_sds' are defined in the environment):
...
# Compute their original standard deviations from the unscaled dataset
original_sds <- sapply(balanced_stroke_tb[, continuous_vars, drop=FALSE], sd, na.rm = TRUE)
...
# Identify the continuous variables that were scaled
continuous_vars <- c("age", "avg_glucose_level", "bmi")  # Adjust as appropriate

# Compute their original standard deviations from the unscaled dataset
original_sds <- sapply(encoded_stroke_tb[, continuous_vars, drop=FALSE], sd, na.rm = TRUE)
