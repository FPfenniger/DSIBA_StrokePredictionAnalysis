...
Our project focuses on developing a robust model for stroke prediction using risk factors. It was inspired by the following studies which provided valuable insights into the various aspects of stroke epidemiology and risk factor analysis:

Arboix (2015)[^3] demonstrates the heterogeneity of ischemic stroke by identifying distinct cardiovascular risk factor profiles for cardioembolic, lacunar, and atherothrombotic subtypes. This study emphasizes the need for a more nuanced understanding of risk factors to improve prevention efforts. To complement this with a broader epidemiological overview, we consider Grysiewicz et al. (2008)[^4], which examines the overall incidence, prevalence, mortality, and risk factors associated with stroke. Complementing those two works, Yi et al. (2020)[^5] employed a population-based cross-sectional survey in Southwestern China to examine stroke prevalence and risk factors. Kelly-Hayes (2010)[^6] offers a supplementary perspective by synthesizing findings from several longitudinal studies to illuminate the long-term impact of age and health behaviors on stroke risk across broader populations.
