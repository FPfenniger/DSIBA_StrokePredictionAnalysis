...
The dataset contains 5,110 patient records with 11 variables describing the patients. Collected attributes include gender, age, history of hypertension, history of heart disease, marital status, occupation sector, residence type, average glucose levels, body mass index (BMI), smoking status, and stroke occurrence.
...
--> just include summary table & statistics here, the previously mentionned part is not necessary, as it was already discussed in the data chapter
...
- `avg_glucose_level`: Right-skewed distribution with a mean of 106.15 and a standard deviation of 45.28. The average glucose levels range from 55.12 to 271.74 mg/dL. Prediabetes and diabetes are associated with a range of 100 to 125 mg/dL and 126 mg/dL or higher, respectively. There seems to be an interesting bimodal pattern in the distribution of glucose levels for individuals with stroke.
