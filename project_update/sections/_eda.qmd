...
We decided to split our EDA into three distinct parts. Part I treats descriptive statistics, the general structure of our dataset and the distribution of the variables. Part II focuses on a univariate analysis of the features and their correlations with the target variable `stroke`. Part III will be dedicated to the bivariate analysis of the features and an examination of multicollinearity. For the visualizations, we opted for interactivity and chose to use `plotly`. This makes our report more engaging and allows for a more in-depth analysis of the data.
...
![hypertension vs. Stroke](../../data/png_for_update/hypertension.png)

![heart_disease vs. Stroke](../../data/png_for_update/heartdisease.png)

![hypertension vs. Stroke](../../data/png_for_update/bmi.png) 

![ever_married vs. Stroke](../../data/png_for_update/ever_married.png) 

![work_type vs. Stroke](../../data/png_for_update/work_type.png)

![Residence_type vs. Stroke](../../data/png_for_update/Residence_type.png)

![smoking_status vs. Stroke](../../data/png_for_update/smoking_status.png)

![gender vs. Stroke](../../data/gender_for_update/bmi.png)
