...
-   Values: 0 (No), 1 (Yes)
-   Description: Indicates whether the individual has hypertension.
...
The dataset is fairly clean. Our dataset contains several categorical variables. Since a machine learning model requires numerical inputs, we distinguished from the beginning categorical and numerical variables.
