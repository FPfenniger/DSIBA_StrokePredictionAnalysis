...
#Responsible person: Bolor
#And put the work into the intermediary report as well.
...
ggplot(preprocessed_stroke_tb, aes(y = hypertension, x = factor(stroke))) + 
  geom_boxplot() +
...
#Responsible person Muhammed

### 3.3 Correlation Analysis
#Responsible person Fabio
