...
while `categorical variables` include
- gender
...
- `age`: The dataset includes patients with ages ranging from 0.8 to 82 years, with an average age of 43.23 years and a standard deviation of 22.61 years, and with a peak around 70 years old.
- `avg_glucose_level`: Right-skewed distribution with a mean of 106.15 and a standard deviation of 45.28. The average glucose levels range from 55.12 to 271.74 mg/dL.
- `bmi`: Right-skewed distribution with a mean of 28.89 and a standard deviation of 7.85. The BMI values range from 10.3 to 97.6.
...
Todo:
exclude other from the barchart
...
- `smoking_status`: The proportion of stroke cases is higher among individuals who formerly smoked compared to those who never smoked or currently smoke.
- `hypertension`: Patients with hypertension have a higher proportion of stroke cases compared to those without hypertension.
- `ever_married`: The proportion of stroke cases is higher among married individuals compared to those who have never married.
- `work_type`: The distribution of stroke cases varies across different work types, with private sector employees and self-employed individuals showing higher proportions of stroke cases compared to other work types.

Not relevant appear to be the following variables as there are no differences in the proportions of stroke cases across the levels:
- `gender`
- `Residence_type`
