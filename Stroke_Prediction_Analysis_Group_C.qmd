...
```{r}
preprocessed1_stroke_tb <- cleaned_stroke_tb %>%
  cleaned_stroke_tb$bmi[is.na(stroke_tb$bmi)] <- median(stroke_tb$bmi, na.rm = TRUE) %>%
  cleaned_stroke_tb$smoking_status [is.na(stroke_tb$smoking_status)] <- 
