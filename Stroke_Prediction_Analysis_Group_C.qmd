...
```{r}
target_var_corr_plots <- lapply(numerical_variables, function(var) {
  ggplot(encoded_stroke_tb, aes_string(x = "factor(target)", y = var)) +
    geom_violin() +
    labs(x = "Stroke Occurrence", y = var, title = paste(var, "by Stroke Occurrence")) +
    theme_minimal()
})
