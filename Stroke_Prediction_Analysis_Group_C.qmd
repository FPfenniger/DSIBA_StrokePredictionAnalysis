...
`age`: The dataset includes patients with ages ranging from 0 to 82 years, with an average age of 43.23 years and a standard deviation of 22.61 years. The distribution of age is right-skewed, with a peak around 70 years old.
...
`stroke`: Among the 5,111 patients, 249 had experienced a stroke, while 4,861 had not. 
`gender`: 2,994 female patients, 2,115 male patients, and 1 patient identified as other.
`ever_married`: 3,529 patients were married, while 1,582 were not.
`work_type`: The majority of patients were employed in private jobs (2,441), followed by self-employed (1,024), government jobs (657), and children (687). Only 22 patients had never worked.
`Residence_type`: 2,290 patients lived in urban areas, while 2,821 lived in rural areas.
`smoking_status`: 1,383 patients never smoked, 789 were former smokers, and 747 were current smokers.
`heart_disease`: 306 patients had a history of heart disease, while 4,805 did not.
