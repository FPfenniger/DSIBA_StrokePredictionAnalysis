...
The dataset comprises 5,110 patient records, each characterized by 11 variables. These variables can be categorized into two types: numerical and categorical. Numerical variables include age, average glucose level, and BMI, while categorical variables include gender, history of hypertension, history of heart disease, marital status, occupation sector, residence type, smoking status, and stroke occurrence.
...
Relevant differences in the proportions of stroke cases can be observed across various categorical variables. For instance,
`heart_disease`
`smoking_status`
`hypertension`
`ever_married`
...
: Among the 5,111 patients, 249 had experienced a stroke, while 4,861 had not. 
`gender`: 2,994 female patients, 2,115 male patients, and 1 patient identified as other. 
`Residence_type`: 2,290 patients lived in urban areas, while 2,821 lived in rural areas. 

Q: Do deep dive if gender, residence type really not relevant variables?
